module rrfs_sd_io
  ...
  public :: rrfs_sd_data_type

  ! These should not need to be public, but some older compilers require it:
  public :: rrfs_sd_register_axis, rrfs_sd_write_axis, rrfs_sd_allocate_data, &
       rrfs_sd_fill_data, rrfs_sd_register_fields, rrfs_sd_deallocate_data, &
       rrfs_sd_copy_to_temporaries, rrfs_sd_copy_from_temporaries, rrfs_sd_final
...
contains
  ...
  subroutine rrfs_sd_register_axis(data,Model,Sfc_restart)
    implicit none
  ...
  subroutine rrfs_sd_write_axis(data,Model,Sfc_restart)
    implicit none
    class(rrfs_sd_data_type) :: data
    type(FmsNetcdfDomainFile_t) :: Sfc_restart
    type(GFS_control_type),      intent(in) :: Model
...
!$omp parallel do default(shared) private(i, j, nb, ix)
  ...
  subroutine rrfs_sd_register_fields(data,Sfc_restart)
