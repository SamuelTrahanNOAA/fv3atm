module FV3GFS_sfc_io
  ...
  public :: Sfc_io_calculate_indices, Sfc_io_allocate_arrays, &
       Sfc_io_copy_to_temporaries, Sfc_io_copy_from_temporaries, &
       Sfc_io_apply_safeguards, Sfc_io_register_fields, &
       Sfc_io_register_axes, Sfc_io_write_axes, &
       Sfc_io_register_2d_fields, Sfc_io_register_3d_fields, &
       Sfc_io_fill_2d_names, Sfc_io_fill_3d_names, &
       Sfc_io_init_fields
  ...
  real, parameter:: min_lake_orog = 200.0_kind_phys
  ...
  contains
    ...
    procedure, public :: copy_to_temporaries => Sfc_io_copy_to_temporaries
    procedure, public :: copy_from_temporaries => Sfc_io_copy_from_temporaries
    procedure, public :: apply_safeguards => Sfc_io_apply_safeguards
    procedure, public :: register_fields => Sfc_io_register_fields
...
contains
  ...
  function Sfc_io_calculate_indices(sfc, Model, warm_start)
    implicit none
  ...
  function Sfc_io_allocate_arrays(sfc, Model, Atm_block, warm_start)
    implicit none
    class(Sfc_io_data_type)             :: sfc
    ...
    Sfc_io_allocate_arrays = sfc%calculate_indices(Model, warm_start)
...
3814    format("ERROR: size mismatch size(sfc%name2)=",I0," /= nvar_before_lake+10=",I0)
  ...
  subroutine Sfc_io_copy_to_temporaries(sfc, Model, Atm_block, Sfcprop)
  ...
  end subroutine Sfc_io_copy_to_temporaries

  subroutine Sfc_io_copy_from_temporaries(sfc, Model, Atm_block, Sfcprop, warm_start, override_frac_grid)
    !--- interface variable definitions
    implicit none
...
!   write(0,*)' sfc_var2=',sfc_var2(:,:,12)
  ...
  end subroutine Sfc_io_copy_from_temporaries
...
subroutine Sfc_io_register_fields(sfc, Model, Sfc_restart)
  implicit none
  class(Sfc_io_data_type)             :: sfc
  type(GFS_control_type),      intent(in) :: Model
...
end subroutine Sfc_io_register_fields
...
subroutine Sfc_io_register_2d_fields(sfc,Model,Sfc_restart)
  implicit none
  class(Sfc_io_data_type)             :: sfc
  type(GFS_control_type),      intent(in) :: Model
  type(FmsNetcdfDomainFile_t) :: Sfc_restart
...
subroutine Sfc_io_register_3d_fields(sfc,Model,Sfc_restart,warm_start)
  implicit none
  class(Sfc_io_data_type)             :: sfc
  type(GFS_control_type),      intent(in) :: Model
  type(FmsNetcdfDomainFile_t) :: Sfc_restart
